...
1. On the **Overview** page, select **Edit** to update the agent details. If the option greyed out, please wait till the agent rovision completes, once the agent provision is completed you will be able to see the edit opton. This might take upto 5 minutes.
